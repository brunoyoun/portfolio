...
#final product
plt.savefig('Assignment_4_Visual',bbox_inches='tight')
plt.show()
...
#Cell to demonstrate that standard deviations of two possible alternative metrics, days and minutes
